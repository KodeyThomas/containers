...
echo "👽 Waiting for zurg to be up in ${ZURG_URL:-"zurg.zurg.svc.cluster.local:9999"}..."
/usr/local/bin/wait-for -t 3600 ${ZURG_URL:-"zurg.zurg.svc.cluster.local:9999"} -- echo "✅"
